...
function getAddButtonEventListeners() {
    let _countObject = getEventListeners(addButton);
    let _count = _countObject.click.length;

    return _count
};

function getRemoveButtonEventListeners() {
    let _countObject = getEventListeners(removeButton);
    let _count = _countObject.click.length;
